...
class LuxCoreNodeMatGlossyTranslucent(LuxCoreNodeMaterial, bpy.types.Node):
    ...
    def update_use_ior_bf(self, context):
            ...
            if ior_input:
                ior_input.enabled = self.use_ior
            specular_color_input = self.inputs.get("BF Specular Color")
            if specular_color_input:
                specular_color_input.enabled = not self.use_ior
            utils_node.force_viewport_update(self, context)
    ...
    def update_use_backface(self, context):
        try:
            ...
            print(f"KeyError in update_use_backface: {e}")
    ...
    def draw_buttons(self, context, layout):
        try:
            ...
            print(f"KeyError in draw_buttons: {e}")
    ...
    def sub_export(self, exporter, depsgraph, props, luxcore_name=None, output_socket=None):
        try:
            ...
            print(f"KeyError in sub_export: {e}")
