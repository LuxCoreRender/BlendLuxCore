...
#
#
# def convert_hair(exporter, obj, psys, luxcore_scene, depsgraph, context=None, engine=None):
#     try:
...
#         if final_render:
#             set_res_start = time()
#             # ToDo2.8 Check if we have to switch between render and viewport
