...
def convert_hair(blender_obj, psys, luxcore_scene, blender_scene, context=None, engine=None):
    ...
    if (context and mod.show_viewport) or (not context and mod.show_render):        
        ...
        mesh = blender_obj.to_mesh(blender_scene, True, modifier_mode)
        ...
        transform = utils.matrix_to_list(blender_obj.matrix_world, blender_scene, apply_worldscale=True)
        ...
        if not context:
            ...
            psys.set_resolution(blender_scene, blender_obj, 'PREVIEW')
