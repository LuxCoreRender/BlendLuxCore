...
from ..utils import find_optix_denoiser
...
class LuxCoreViewportSettings(bpy.types.PropertyGroup):
    ...
    def update_optix_enabled(self, context):
        find_optix_denoiser(context.scene)

    optix_enabled = BoolProperty(name="Use Optix", default=False, update=update_optix_enabled)
