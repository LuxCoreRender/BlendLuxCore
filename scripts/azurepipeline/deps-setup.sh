...
dpkg -i popularity-contest_1.57ubuntu1_all.deb 
dpkg -i neurodebian-popularity-contest_0.39.0~nd14.04+1_all.deb 
dpkg -i p7zip_16.02+dfsg-1~nd14.04+1_amd64.deb 
dpkg -i p7zip-full_16.02+dfsg-1~nd14.04+1_amd64.deb
